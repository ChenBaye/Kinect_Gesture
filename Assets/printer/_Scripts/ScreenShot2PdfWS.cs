...
*Modifier:ZoJet
*Modify Reason:1.屏幕截图指定区域 2.保存图片 3.转换为PDF
*Modify Content:
*/
...
public class ScreenShot2PdfWS : MonoBehaviour
{
    ...
    //    picPath = "Assets/StreamingAssets/Report";
    //    pdfPath = "Assets/StreamingAssets/Report";
    ...
    //    Directory.CreateDirectory(Application.streamingAssetsPath+"/Report/" + UserModle.personId.ToString());
    //    picPath = Application.streamingAssetsPath+ "/Report/" + UserModle.personId.ToString();
    //    pdfPath = Application.streamingAssetsPath+"/Report/" + UserModle.personId.ToString();
    //}
    ...
    //    Texture2D tex = new Texture2D(650, height, TextureFormat.RGB24, true);
    //    tex.ReadPixels(new Rect(width, 0, 650, height), 0, 0, false);
